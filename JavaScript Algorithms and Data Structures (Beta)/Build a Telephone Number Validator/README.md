...
18. When `#user-input` contains **123**&!!asdf#** and `#check-btn` is clicked, the `#results-div` should contain the text **"Invalid US number: 123**&!!asdf#"**.
...
32. When `#user-input` contains **(555)5(55?)-5555** and `#check-btn` is clicked, the `#results-div` should contain the text **"Invalid US number: (555)5(55?)-5555"**.
